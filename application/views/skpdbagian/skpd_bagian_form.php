<div class="row">
    <div class="col-xs-12 col-md-6">
	    ...
	    <div class="form-group">
            <label for="int">Skpd Id <?php echo form_error('skpd_id') ?></label>
            <input type="text" class="form-control" name="skpd_id" id="skpd_id" placeholder="Skpd Id" value="<?php echo $skpd_id; ?>" />
        </div>
	    <div class="form-group">

...
<div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">List Pangkat</h3>
        ...
        <form id="myform" method="post" onsubmit="return false">
           ...
           <div class="row" style="margin-bottom: 10px">
            <div class="col-xs-12 col-md-4">
                <?php echo anchor(site_url('pangkat/create'), '<i class="fa fa-plus"></i> Create', 'class="btn bg-purple"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "pangkat/json", "type": "POST"},
                    columns: [
                         {
                            "data": "id",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "golongan"},{"data": "ruang"},{"data": "nama_pangkat"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"

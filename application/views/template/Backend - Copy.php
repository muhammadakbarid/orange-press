...
<body class="sidebar-mini hold-transition skin-purple-light fixed sidebar-collapse">
<!-- Site wrapper -->
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url();?>" class="logo">
      ...
      <span class="logo-mini"><b><i class="fa fa-hospital-alt"></i></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><i class="fa fa-hospital-alt"></i> <b>HOSPITAL</b>MS</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Tama</span>
            </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://Solutama.com">SOLUTAMA</a>.</strong> All rights
    reserved.
  </footer>

...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jan 2021 pada 11.11
...
(42, 20, 2, 40, 'fas fa-users-cog', 'User', '#', '1', 1),
(43, 21, 3, 42, 'fas fa-angle-double-right', 'Users', 'users', '1', 1),
(44, 22, 3, 42, 'fas fa-angle-double-right', 'Groups', 'groups', '2', 1),
...
--
-- Struktur dari tabel `program_sub_kegiatan`
--
...
--
-- Dumping data untuk tabel `program_sub_kegiatan`
--
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@amizan.com', '', 'm0vyKu2zW7L8PTG20bquF.707e055aeea8a30aca', 1541329145, 'WcHCQ5vcXwT1z99BvJUWnu', 1268889823, 1609997907, 1, 'Admin', 'istrator', 'ADMIN', '0'),
...
--
-- Indeks untuk tabel `program_sub_kegiatan`
--
...
--
ALTER TABLE `menu`
  MODIFY `id_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
-- AUTO_INCREMENT untuk tabel `program_sub_kegiatan`
--
ALTER TABLE `program_sub_kegiatan`

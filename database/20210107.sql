...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2021 at 04:02 AM
...
(93, 5, 2, 92, 'fas fa-archive', 'SKPD', '#', 'bagianskpd', 1),
(95, 6, 3, 93, 'fas fa-bars', 'Bagian SKPD', 'SkpdBagian', 'BagianSkps', 1),
(96, 7, 3, 93, 'fas fa-bars', 'Sub Bagian SKPD', 'SkpdSubBagian', 'SkpdSubBagian', 1),
(97, 3, 2, 92, 'fas fa-award', 'Pangkat', 'Pangkat', 'Pangkat', 1),
(98, 4, 2, 92, 'fas fa-user-tie', 'Pegawai', 'Pegawai', 'Pegawai', 1),
(99, 8, 2, 92, 'fas fa-location-arrow', 'Wilayah', '#', 'wilayah', 1),
(100, 11, 3, 99, 'fas fa-arrow-alt-circle-right', 'Kecamatan', 'kecamatan', 'kecamatan', 1),
(101, 10, 3, 99, 'fas fa-arrow-alt-circle-right', 'Kabupaten', 'kabupaten', 'kabupaten', 1),
(102, 9, 3, 99, 'fas fa-arrow-alt-circle-right', 'Provinsi', 'provinsi', 'provinsi', 1);
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@amizan.com', '', 'm0vyKu2zW7L8PTG20bquF.707e055aeea8a30aca', 1541329145, 'WcHCQ5vcXwT1z99BvJUWnu', 1268889823, 1609986396, 1, 'Admin', 'istrator', 'ADMIN', '0'),
